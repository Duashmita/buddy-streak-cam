  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-display font-bold gradient-text">Habpet</h1>
      ...
      <AlertDialog>
        ...
        <AlertDialogContent className="glass-card border-border/50">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will delete all your progress, including your streak and milestones. You'll need to set up a new
              habit from scratch.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
